...
# Math can also be done on the variables themselves.
# Expressions can also be put directly into the print function.
print(x + y)                # prints "19"

# Examples of possible mathematical operations
print(x - y)                # prints "1"
print(y / x)                # prints "0.9"
print(x * y)                # prints "190"
print(x ** y)               # prints ?
print(x // y)               # prints ?
print(x % y)                # prints ?